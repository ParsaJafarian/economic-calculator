...
public class CompoundForm extends Form {
    ...
    public CompoundForm() {
        ...
        limitPercentField(interestField);
    }
     ...
     */
    static @NotNull ObservableList<Row> computeCompoundInterest(double initInv, int years, double interest, int freq, double yearlyAddition) {
    ...
    public void displayInformationAlert() {
        ...
        alert.setContentText("Compound interest involves earning or paying interest on" + " both the initial amount and the previously earned interest, resulting" + " in the exponential growth of the total amount over time. To learn more," + " visit https://en.wikipedia.org/wiki/Compound_interest");
        alert.showAndWait();
    }
